...
@section('content')
    ...
    <div class="d-none d-lg-flex col-lg-6 col-xl-7 align-items-center p-5">
        <div class="w-100 d-flex justify-content-center">
            <img src="{{ asset('assets/img/branding/atm.png') }}"
                 class="img-fluid"
                 alt="{{ env('APP_NAME') }}"
                 width="500"
            />
    ...
    <div class="d-flex col-12 col-lg-6 col-xl-5 align-items-center authentication-bg p-sm-5 p-4">
        <div class="w-px-400 mx-auto">
            ...
            <h4 class="mb-2"> Login To ATM </h4>
            <form id="formAuthentication" class="mb-3 submit_form_loader_btn" action="{{ route('login') }}"
                  method="POST">
                @csrf
                <div class="mb-3">
                    <label for="email" class="form-label"> Card Number  <b class="text-danger">*</b>
                    </label>
                    <input
                        type="text"
                ...
                <div class="mb-3 form-password-toggle">
                    <div class="d-flex justify-content-between">
                        <label class="form-label" for="pin">Pin<b
                    ...
                    <div class="input-group input-group-merge">
                        <input
                            ...
                            value="{{old('pin')}}"
                            placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                            aria-describedby="Enter Pin" required
                        />
